...
CHROMA_PATH = "chroma_bian"
FILE_PATH = "data/files"

# Define the columns we want to embed vs which ones we want in metadata
columns_to_embed = ["Service Domain", "genericArtefactType", "Role Definition"]
columns_to_metadata = ["Service Domain", "Business Area", "Business Domain", "functionalPattern", "assetType", "genericArtefactType", "Examples Of Use", "Role Definition"]
